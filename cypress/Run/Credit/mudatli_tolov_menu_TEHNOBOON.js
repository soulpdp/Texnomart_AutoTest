...
import Mudatli_tolov_pom_TEHNOBOON from "../../POM/Credit/Mudatli_tolov_pom_TEHNOBOON";

function run_all_logic_TEHNOBOON() {
    cy.fixture("mudatli_tolov_assertion.json").then((data) => {
        const credit = new Mudatli_tolov_pom_TEHNOBOON();
...
module.exports = run_all_logic_TEHNOBOON;
