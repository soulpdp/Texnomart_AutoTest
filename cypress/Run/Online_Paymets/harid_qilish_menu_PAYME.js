...
import Mudatli_tolov_pom_Payme from "../../POM/Online_Payments/Harid_qilish_pom_Payme";

function run_the_buy_PAYME() {
    cy.fixture("mudatli_tolov_assertion.json").then((data) => {

        const credit = new Mudatli_tolov_pom_Payme();
...
module.exports = run_the_buy_PAYME;
